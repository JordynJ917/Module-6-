...
//         let newCats = currentCats.filter(cat => cat.latinName.startsWith('Panthera')); // case sensitive
//         setCurrentCats(newCats);
//     }
...
import "./BigCat.css"; // Ensure this CSS file exists or remove the import if not needed.
